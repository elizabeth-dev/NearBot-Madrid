...
const regex = { // Strings for sending and comparing messages to regex
	metro: { text: 'Vamos a buscar estaciones de metro. ', table: 'NearBot_Madrid_Transport', type: 'metro' },
	cercanias: { text: 'Vamos a buscar estaciones de cercanías. ', table: 'NearBot_Madrid_Transport', type: 'commuter' },
	metroligero: { text: 'Vamos a buscar estaciones de metro ligero. ', table: 'NearBot_Madrid_Transport', type: 'tram' },
	transporte: { text: 'Vamos a buscar estaciones de cualquier medio de transporte. ', table: 'NearBot_Madrid_Transport', type: null },
	fuente: { text: 'Vamos a buscar fuentes de agua. ', table: 'NearBot_Madrid_Fountain', type: null },
	bici: { text: 'Vamos a buscar bases de BiciMAD. ', table: 'NearBot_Madrid_Bike', type: null },
	aseo: { text: 'Vamos a buscar el aseo más cercano. ', table: 'NearBot_Madrid_WC', type: null },
	carrefour: { text: 'Vamos a buscar el supermercado Carrefour más cercano. ', table: 'NearBot_Madrid_Supermarket', type: 'carrefour' },
	mercadona: { text: 'Vamos a buscar el supermercado Mercadona más cercano. ', table: 'NearBot_Madrid_Supermarket', type: 'mercadona' },
	supermercado: { text: 'Vamos a buscar el supermercado más cercano. ', table: 'NearBot_Madrid_Supermarket', type: null },
}
