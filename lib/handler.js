...
function doTheSearch(type, reply, coordinates) {
	...
	switch (type) {
		...
		config = {
			TableName: 'NearBot_Madrid_Transport',
			FilterExpression: 'contains(#types, :type)',
			ExpressionAttributeNames: { '#types': 'type' },
			ExpressionAttributeValues: { ':type': 'Metro' }
			}
		...
		config = {
			...
			FilterExpression: 'contains(#types, :type)',
			ExpressionAttributeNames: { '#types': 'type' },
			ExpressionAttributeValues: { ':type': 'Cercanías' }
			}
		...
		config = {
			...
			FilterExpression: 'contains(#types, :type)',
			ExpressionAttributeNames: { '#types': 'type' },
			ExpressionAttributeValues: { ':type': 'Metro Ligero' }
			}
		...
		case 'crf':
		config = {
			TableName: 'NearBot_Madrid_Supermarket',
			FilterExpression: 'contains(#types, :type)',
			ExpressionAttributeNames: { '#types': 'type' },
			ExpressionAttributeValues: { ':type': 'Carrefour' }
			}
		...
		config = {
			...
			FilterExpression: 'contains(#types, :type)',
			ExpressionAttributeNames: { '#types': 'type' },
			ExpressionAttributeValues: { ':type': 'Mercadona' }
			}
		...
		case 'fuente':
		config = {
			TableName: 'NearBot_Madrid_Fountain'
		}
