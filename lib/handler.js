...
bot.command('novedades', (msg, reply) => {
	stats.duration.sentRes = new Date().getTime() - stats.date
	reply.markdown('*Versión 2.1.0*\n\n- Se ha corregido un fallo a la hora de procesar los horarios de los supermercados\n- Se han actualizado las dependencias').then((err, res) => postMessage(err, res, stats))
